  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive flex h-9
        w-fit items-center justify-between gap-2 rounded-md border bg-transparent px-3
        ...
        disabled:opacity-50 *:data-[slot=select-value]:line-clamp-1
